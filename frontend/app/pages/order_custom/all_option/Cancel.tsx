...
function Cancel() {
        ...
        const fetchData = async () => {
            try {
                const request = await axios({
                    method: "post",
                    url: "http://localhost:4000/order/user/cancel",
                    data: {
    ...
    return (
        <div className={cx("height-fix")}>
            {!data ? <div className={cx("wrapper_no_order")}>
                        ...
                        <div key={d} className={cx("list_order")}>
                                    ...
                                    <div className={cx("wrapper_transition")}>
                                        ...
                                        <div className={cx("information_transition")}>
                                            <div className={cx("transition")}>
                                                ...
                                                <span className={cx("text")}> Đơn hàng đã bị hủy</span>
                            ...
                            <div className={cx("payment")}>
                                <div className={cx("flex", "justify-end", "items-center")}>
                                    ...
                                    <button onClick={() => router.push(`/Layout/newproducts/${i.name_product}`)} className={cx("buy")}>Mua lại</button>
                                </div>
                            </div>
                        </div>
                    )
